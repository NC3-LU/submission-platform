    ...
    <div class="py-12">
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow rounded-xl p-8 text-center">
                ...
                @if(session('submission_receipt'))
                    <p class="my-4 text-sm text-gray-700 dark:text-gray-200">Reference: <strong class="break-all">{{ session('submission_receipt') }}</strong>. Keep this reference if you contact support.</p>
                @endif
